        ...
        <label htmlFor={props.id} className="flex flex-col h-full space-y-3.75">
            ...
            <div className="">
                {props.image
                    ...
                    :
                    <div
                        className="grow flex flex-col h-auto p-7.5 items-center justify-center border-2 border-dashed border-indigo-500/40 rounded-2.5xl space-y-12.5 hover:cursor-pointer hover:border-solid">
                        {uploadIcon}
