    ...
    return (
        <div className="flex flex-col p-6 bg-white rounded-2.5xl gap-5 divide-y">
            <div className="flex flex-col gap-4">
                ...
                <div className="flex p-2 flex-col text-base text-black-500">
                    <div className="flex justify-between">
                        <span>APR:</span>
                        <span className="font-bold">{props.apr}%</span>
                    </div>
                    <div className="flex justify-between">
                        <span>Stake:</span>
                        <span className="font-bold">{props.stake}</span>
                    </div>
                    <div className="flex justify-between">
                        <span>Earn:</span>
                        <span className="font-bold">{props.earn}</span>
                    </div>
                </div>

                <div className="flex px-2 justify-between text-2xl">
                    <span>Deposit Fee:</span>
                    <span className="font-bold">{props.depositFee}%</span>
                </div>

                <div className="flex flex-col px-2 gap-1">
                    <label><span className="font-bold">{props.earn}</span> EARNED</label>
                    <div className="grid grid-cols-2 gap-2">
                        <InputEmpty id="mercor-earned" name="earned" type="number" value="0" readOnly />
                        <ButtonFit name="Harvest" />
                    </div>
                </div>

                <div className="flex flex-col px-2 gap-1">
                    <label><span className="font-bold">{props.title}</span> STAKED</label>
